    ...
    return (
        <div>
            <Card id='narrative'>
                ...
                <p>
                    Comensurate with the scale of the pandemic, the volume of data on COVID-19 is staggering. This is a tool for users undertaking specific, targeted research.
                </p>
                <p>
                ...
                <p>
                    Download your data to an Excel file by clicking the "Download to Excel" button on the navigation bar.
                </p>
                <p>
